              ...
              function (event) {
                ...
                if (form.checkValidity() === true) {
                  ...
                  if (isContactForm) {
                    ...
                    var alertClass = 'alert-danger'; // Default is error
                    ...
                    fetch('assets/php/contact.php', {
                      ...
                      .then((jsonData) => {
                        ...
                        if (jsonData.success) {
                          alertClass = 'alert-success'; // Change to success alert
                        }

                        // Construct the alert box based on the response
                        alertBox =
                          '<div class="alert ' +
                          alertClass +
                        ...
                        // Insert the alert box in the form
                        form
